...
// Resolves a citation path found in `citingFile`'s text: starts with "./" or
// "../" -> relative to the citing file's directory (like a markdown link);
// otherwise -> relative to the repository root (`process.cwd()`). Shared by
// version-citations and, later, dead-citations — both need the identical
// path-resolution semantics for a citation string found in prose.
...
module.exports = { walkScoped, walkTree, underPrefix, toNative, scopedFiles, resolveCitedPath };
