...
//
// `(?!\/v\d)` exclui uma enumeração histórica tipo "v1.6/v1.9/v1.17" (várias
// versões PASSADAS do mesmo arquivo, citadas juntas como registro de quando
// cada uma valeu) — medido no mesmo corpus (`docs/RUNBOOK.md`): é uma citação
// de intervalo/série, a mesma classe que a notação "006-008 v1.9/v1.9/v1.10"
// já excluída por desenho, só que para 1 arquivo em vez de vários.
