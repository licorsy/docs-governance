...
// Extracted from dead-citations.js and numbered-reference-consistency.js,
// where it was defined identically in both — the same
// "common logic moves up to lib/" principle documented above.
function escapeRegExp(s) {
  return s.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
}

module.exports = { stripFencedBlocks, fencedLineIndices, changelogBlockRange, markedBlockLines, escapeRegExp };
